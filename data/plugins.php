...
- Manage user hourly rates
    ...
    'rocketchat' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-rocketchat/releases/download/v1.0.4/RocketChat-1.0.4.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.32',
    ],
    'sendgrid' => [
    ...
    'slack' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-slack/releases/download/v1.0.5/Slack-1.0.5.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.32',
    ],
    'sms-2fa' => [
