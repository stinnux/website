...
- Manage user hourly rates
    ...
    'mailgun' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-mailgun/releases/download/v1.0.6/Mailgun-1.0.6.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.37',
    ],
    'mattermost' => [
    ...
    'milestone' => [
         ...
         'download' => 'https://github.com/oliviermaridat/kanboard-milestone-plugin/releases/download/1.0.36/Milestone-1.0.36-1.zip',
         'remote_install' => true,
         'compatible_version' => '1.0.36',
    ],
    'oauth2' => [
        'title' => 'OAuth2',
        'version' => '1.0.1',
    ...
    'postmark' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-postmark/releases/download/v1.0.6/Postmark-1.0.6.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.37',
    ],
    'rabbitmq' => [
    ...
    'sendgrid' => [
        ...
        'download' => 'https://github.com/kanboard/plugin-sendgrid/releases/download/v1.0.5/Sendgrid-1.0.5.zip',
        'remote_install' => true,
        'compatible_version' => '>=1.0.37',
    ],
    'slack' => [
